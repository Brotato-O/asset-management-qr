...
import org.example.backend.asset.Category.AssetCategory;
...
public class Asset {
    ...
    public Asset(Integer id, String name, AssetCategory category, BigDecimal purchasePrice,
                 ...
                 LocalDate warrantyExpiryDate, AssetStatus status, AssetCondition conditionStatus, String isDeleted, LocalDateTime deletedAt) {
        this.id = id;
        this.name = name;
